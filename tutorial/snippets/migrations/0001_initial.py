    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_or_away', models.CharField(max_length=4, choices=[(b'home', b'home'), (b'away', b'away')])),
                ('opp_team', models.CharField(max_length=3)),
                ('result', models.CharField(max_length=10)),
                ('gs', models.CharField(max_length=10, null=True, blank=True)),
                ('pass_comp', models.IntegerField(null=True, blank=True)),
                ('pass_att', models.IntegerField(null=True, blank=True)),
                ('comp_pct', models.DecimalField(null=True, max_digits=5, decimal_places=2, blank=True)),
                ('pass_yards', models.IntegerField(null=True, blank=True)),
                ('pass_tds', models.IntegerField(null=True, blank=True)),
                ('ints_thrown', models.IntegerField(null=True, blank=True)),
                ('qb_rating', models.DecimalField(null=True, max_digits=4, decimal_places=1, blank=True)),
                ('yards_per_pass_att', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('adj_yards_per_pass_att', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('rush_att', models.IntegerField(null=True, blank=True)),
                ('rush_yards', models.IntegerField(null=True, blank=True)),
                ('yards_per_rush_att', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('rush_tds', models.IntegerField(null=True, blank=True)),
                ('pass_tgts', models.IntegerField(null=True, blank=True)),
                ('receptions', models.IntegerField(null=True, blank=True)),
                ('rec_yards', models.IntegerField(null=True, blank=True)),
                ('yards_per_rec', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('rec_tds', models.IntegerField(null=True, blank=True)),
                ('two_pt_conv_made', models.IntegerField(null=True, blank=True)),
                ('punt_returns', models.IntegerField(null=True, blank=True)),
                ('pr_yards', models.IntegerField(null=True, blank=True)),
                ('yards_per_punt_return', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('pr_tds', models.IntegerField(null=True, blank=True)),
                ('kickoff_returns', models.IntegerField(null=True, blank=True)),
                ('kr_yards', models.IntegerField(null=True, blank=True)),
                ('yards_per_kick_return', models.DecimalField(null=True, max_digits=4, decimal_places=2, blank=True)),
                ('kr_tds', models.IntegerField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='PFRtoGuidModel',
            fields=[
                ('pro_football_ref_name', models.CharField(max_length=30, serialize=False, primary_key=True)),
                ('player_full_name', models.CharField(max_length=50)),
                ('pguid', models.CharField(max_length=40, editable=False, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
